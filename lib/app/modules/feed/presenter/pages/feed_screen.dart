...
import 'package:reelshop/app/modules/messages/presenter/messages_screen.dart';
import 'package:reelshop/app/modules/profile/presenter/profile_screen.dart';
import 'package:reelshop/app/modules/search/presenter/search_screen.dart';
import 'package:reelshop/app/shared/widgets/actions_toolbar.dart';
import 'package:reelshop/app/shared/widgets/video_description.dart';
...
class _FeedScreenState extends State<FeedScreen> {
  final feedViewModel = Modular.get<FeedViewModel>();
  @override
  void initState() {
  ...
  Widget videoScreen() {
    return Scaffold(
      backgroundColor: Modular.get<FeedViewModel>().actualScreen == 0 ? Colors.black : Colors.white,
      body: Stack(
        children: [
          PageView.builder(
            itemCount: 2,
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                VideoDescription(
                  username: video.user,
                  videtoTitle: video.videoTitle,
                  songInfo: video.songName,
                ),
                ActionsToolbar(
                  numLikes: video.likes,
                  numComments: video.comments,
                  userPic:
                      "https://www.andersonsobelcosmetic.com/wp-content/uploads/2018/09/chin-implant-vs-fillers-best-for-improving-profile-bellevue-washington-chin-surgery.jpg",
                ),
              ],
